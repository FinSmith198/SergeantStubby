...
public class BotReadier extends ListenerAdapter {
    ...
    public void onReady(@NotNull ReadyEvent event){
        ...
        // fun/useful commands
        commandData.add(Commands.slash("set-activity", "Sets Stubby's current discord activity").addOptions(
        ...
        commandData.add(Commands.slash("set-member-levelling", "Turns On/Off the levelling of the given member. set:{true/false} member:{@member_ping}").addOptions(
        ...
        // HLL Commands
        commandData.add(Commands.slash("reset-seeding-leaderboard", "Resets all of the Players Seeding time to 0 in the leaderboard, Current Scores will not be saved.").addOptions(
                ...
                .setDefaultPermissions(DefaultMemberPermissions.enabledFor(Permission.MANAGE_SERVER)));
        commandData.add(Commands.slash("add-full-vip", "Adds a Permanent VIP to the DD Server with given steam_id and name.").addOptions(
        ...
        commandData.add(Commands.slash("add-temp-vip", "Adds a Temporary VIP to the DD Server with given name, steam_id, and time.").addOptions(
                        new OptionData(OptionType.STRING, "name", "The New Members' Username (does not need to be accurate, just for reference).", true),
                        new OptionData(OptionType.STRING, "steam-id", "The New Members' Steam ID. This needs to be accurate and is the 17-digit number on their profile.", true),
                ...
                .setDefaultPermissions(DefaultMemberPermissions.enabledFor(Permission.MODERATE_MEMBERS)));
        commandData.add(Commands.slash("add-group-vip", "Adds (temp) VIP to players on the HLL server for a given amount of time. If already vip, does'nt add").addOptions(
