        ...
        switch (command) {
            case "set-dd-promotion-message" -> {
                ...
                if (!Bot.getTagRestrictorStatus()) {
                    ...
                    s = "The automatic message posted to DD general when members are promoted/recruited is no longer active";
                    if (Bot.setPromotionMessageStatus(choice)) {
                        s = "The automatic message posted to DD general when members are promoted/recruited is now active";
                    }
                }
            ...
            case "reset-seeding-leaderboard" -> {
                event.deferReply(true).queue();
